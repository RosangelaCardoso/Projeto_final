        ...
        <div className="md:grid md:grid-cols-4 md:gap-8">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" aria-label="Instagram" className="text-white hover:text-gray-300 transition-colors duration-200">
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 fill-current">
              ...
              <a href="#" aria-label="Twitter" className="text-white hover:text-gray-300 transition-colors duration-200">
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 fill-current">
                  <title>Twitter</title>
